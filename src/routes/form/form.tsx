      ...
      <div className="form-page">
        <form onSubmit={this.handleSubmit} className="form" data-testid="form">
          <label>
            ...
            <input type="text" ref={this.productNameInput} className="form__input_text" required />
          </label>
          <label>
            <span>Release date:</span>
            <input type="date" ref={this.releaseDateInput} className="form__input_date" required />
          </label>
          <label>
            <span>Category:</span>
            <select
